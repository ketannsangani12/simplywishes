          ...
          <div class="p-6 sm:p-8 bg-slate-50/60 dark:bg-background-dark/60 border-b border-border-light dark:border-border-dark">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div class="flex items-center gap-3">
                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gray-200 text-text-light dark:bg-gray-700 dark:text-text-dark">Draft</span>
                <h1 class="text-2xl sm:text-3xl font-bold text-brand-blue-light dark:text-brand-blue-dark">Draft3</h1>
              </div>
              <div class="flex items-center gap-3">
                <button class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-primary/20 text-brand-blue-light dark:text-primary text-sm font-semibold hover:bg-primary/30 transition">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div class="lg:col-span-1">
                <div class="rounded-xl border border-border-light dark:border-border-dark overflow-hidden bg-white dark:bg-surface-dark shadow-sm">
                  <img alt="Wish preview" class="w-full object-cover aspect-[4/3]" src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=800&q=80" />
                  <div class="p-4 flex items-center justify-between">
                    ...
                    <span class="text-xs font-semibold px-3 py-1 rounded-full bg-amber-100 text-amber-700">In Review</span>
                  </div>
                </div>
              </div>
                ...
                <div class="grid sm:grid-cols-2 gap-4 text-sm">
                  ...
                  <div class="flex gap-3">
                    ...
                    <div>
                      ...
                      <p class="font-semibold">October 6, 2025</p>
                    </div>
                  </div>
                  <div class="flex gap-3">
                    ...
                    <div>
                      ...
                      <p class="font-semibold">Financial (You need a PayPal account in order to grant a Financial Wish)</p>
                    </div>
                  </div>
                  <div class="flex gap-3">
                    <span class="material-icons text-primary">paid</span>
                    <div>
                      <p class="text-text-muted-light dark:text-text-muted-dark">Wish Expected Cost</p>
                      <p class="font-semibold">$467</p>
                    </div>
                  </div>
                  <div class="flex gap-3">
                    ...
                    <div>
                      ...
                      <p class="font-semibold">GoFundMe</p>
                    </div>
                  </div>
                  <div class="flex gap-3 sm:col-span-2">
                    <span class="material-icons text-primary">notes</span>
                    <div>
                      <p class="text-text-muted-light dark:text-text-muted-dark">Wish Description</p>
                  ...
                  <div class="flex-1">
                    <div class="flex items-center justify-between">
                      <div class="space-y-1">
                        ...
                        <div class="text-xs text-text-muted-light dark:text-text-muted-dark">December 1 2025 9:26 am</div>
                      </div>
                    ...
                    <p class="mt-2 text-text-light dark:text-text-dark">sajdkjsad</p>
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div class="flex-1">
                    <div class="flex items-center justify-between">
                      <div class="space-y-1">
                        <p class="font-semibold text-primary">Ketan S</p>
                        <div class="text-xs text-text-muted-light dark:text-text-muted-dark">December 1 2025 9:27 am</div>
                      </div>
                      <div class="flex items-center gap-2 text-text-muted-light dark:text-text-muted-dark">
                        <button class="hover:text-primary" aria-label="Edit"><span class="material-icons !text-base">edit</span></button>
                        <button class="hover:text-red-500" aria-label="Delete"><span class="material-icons !text-base">delete</span></button>
                    ...
                    <p class="mt-2 text-text-light dark:text-text-dark">sjdsjd</p>
                    <div class="mt-3 flex items-center gap-4 text-sm text-text-muted-light dark:text-text-muted-dark">
                      <button class="inline-flex items-center gap-1 hover:text-red-500">
                        <span class="material-icons !text-base text-red-500">favorite</span>
                        <span>Love</span>
