                ...
                <article class="bg-surface-light rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                  ...
                  <div class="p-4 space-y-3">
                    ...
                    <div class="flex items-center gap-2">
                      <a class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-gray-200 text-sm font-semibold text-brand-blue-light hover:border-primary hover:text-primary transition-colors" href="{{ route('wishes.show', ['wish' => $wish->w_id, 'source' => 'drafts']) }}">
                      ...
                      <form action="{{ route('wishes.destroy', $wish->w_id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button class="inline-flex items-center justify-center px-3 py-2 rounded-lg bg-red-50 text-red-600 text-sm font-semibold hover:bg-red-100 transition-colors" type="button" data-confirm-delete data-confirm-title="Are you sure you want to delete this wish draft?">
